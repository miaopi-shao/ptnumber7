...
//版本資訊與版權聲明:這部分聲明了你正在使用的是 jQuery v1.9.1 的版本，由 jQuery Foundation 開發與維護。
//版權屬於 jQuery Foundation，並根據其授權條款 (license) 使用。你可以查看授權條款的細節於 jquery.org/license。
/*! jQuery v1.9.1 | (c) 2005, 2012 jQuery Foundation, Inc. | jquery.org/license

//Source Mapping:
//@ sourceMappingURL=jquery.min.map
//這行是一個來源地圖（Source Map）的註解。它的作用是連結壓縮過的程式碼（如 jquery.min.js）到其未壓縮的原始碼版本。
//當你在瀏覽器中進行除錯（Debug）時，來源地圖會讓你看到程式的原始碼（非壓縮且格式化的程式碼），這樣會更容易閱讀和除錯。
//這行註解告訴瀏覽器或開發工具去尋找 jquery.min.map 文件，該文件描述了壓縮碼與原始碼之間的對應關係。
